...
# def q_learning(env, episodes=500, alpha=0.1, gamma=0.95, epsilon=0.001, render=False, log_interval=100):
#     # Q table 초기화
...
def q_learning(env, episodes=500, alpha=0.1, gamma=0.99, epsilon=0.01, render=False, log_interval=100):
    Q = defaultdict(lambda: {a: 0.0 for a in Action})
